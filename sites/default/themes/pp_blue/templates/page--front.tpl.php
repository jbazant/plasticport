  ...
  <section class="l-home-nav">
      ...
      <div class="l-home-nav__img">
        <picture>
          <source media="(min-width: 700px)"
                  srcset="<?= url($theme_path . '/img/img-hp-01.jpg') . ', ' . url($theme_path . '/img/img-hp-01-2x.jpg') . ' 2x' ?>">
          <?= theme('image', array(
    ...
    <a href="<?= url('/produkty') ?>" class="l-home-nav__item">
      <div class="l-home-nav__img">
        <picture>
          <source media="(min-width: 700px)"
                  srcset="<?= url($theme_path . '/img/img-hp-02.jpg') . ', ' . url($theme_path . '/img/img-hp-02-2x.jpg') . ' 2x' ?>">
          <?= theme('image', array(
