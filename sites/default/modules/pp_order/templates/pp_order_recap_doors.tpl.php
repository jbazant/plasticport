<?php
/**
 * Template s rekapitulaci poptavky kyvnych vrat.
 *
 ...
 *
 * @var string $typ_dveri
 * @var string $ram
 * @var string $vypln
 *
 */
?>
<h2>Poptávka kyvných vrat</h2>
...
<table class="recap-table">
    ...
    <tr>
        <th class="col1">Typ dveří:</th>
        <td class="col2"><?php print $typ_dveri; ?></td>
        <th class="col3">Rám:</th>
        <td class="col4"><?php print $ram; ?></td>
    </tr>
    <tr>
        <th class="col1">Výplň:</th>
        <td class="col2" colspan="3"><?php print $vypln; ?></td>
    </tr>
